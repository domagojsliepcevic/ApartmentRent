    ...
    public partial class InitialSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 18, 17, 44, 11, 686, DateTimeKind.Local).AddTicks(1029), "domagoj.sliepcevic@racunarstvo.hr", "Domagoj Sliepcevic" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 1, 18, 17, 44, 11, 694, DateTimeKind.Local).AddTicks(4382), "Kafe aparat", "Coffee maker", 1 },
                    { 2, new DateTime(2023, 1, 18, 17, 44, 11, 694, DateTimeKind.Local).AddTicks(5550), "Perilica sudja", "Dishwasher", 1 },
                    { 3, new DateTime(2023, 1, 18, 17, 44, 11, 694, DateTimeKind.Local).AddTicks(5597), "Balkon", "Balcony", 2 },
                    { 4, new DateTime(2023, 1, 18, 17, 44, 11, 694, DateTimeKind.Local).AddTicks(5601), "Kupaonica", "Bathroom", 2 },
                    { 5, new DateTime(2023, 1, 18, 17, 44, 11, 694, DateTimeKind.Local).AddTicks(5604), "Kada", "Bathtub", 2 },
                    { 6, new DateTime(2023, 1, 18, 17, 44, 11, 694, DateTimeKind.Local).AddTicks(5607), "Bide", "Bidet", 2 }
                });
